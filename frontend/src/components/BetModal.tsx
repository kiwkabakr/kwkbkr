...
const BET_COMMAND = '/bet xxdd22xcgj'
...
export function BetModal({ onClose }: { onClose: () => void }) {
  ...
  const handleCopy = () => {
    ...
    navigator.clipboard.writeText(BET_COMMAND).catch(() => {})
    setCopied(true)
  ...
  return createPortal(
    <div className="bet-modal-overlay" onClick={close}>
      ...
      >
        ...
        <h2 className="bet-modal__title">Jak stworzyć beta?</h2>

        {/* Step 1 — Telegram */}
        <p className="bet-modal__step-label">Dołącz na Telegram czutka.gg</p>
        <div className="bet-modal__row bet-modal__row--telegram">
          <div className="bet-modal__row-left">
            <TelegramIcon />
            <span className="bet-modal__row-text">www.telegram.com/czutka</span>
          </div>
          <a
            href="https://t.me/czutkagg"
            target="_blank"
        ...
        {/* Step 2 — Command */}
        <p className="bet-modal__step-label">I wklej te komende</p>
        <div className="bet-modal__row bet-modal__row--command">
          <div className="bet-modal__row-left">
            <LinkIcon />
            <span className="bet-modal__row-text bet-modal__row-text--accent">{BET_COMMAND}</span>
          </div>
        ...
        <p className="bet-modal__desc">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam auctor tincidunt augue,
          eu imperdiet libero pharetra id. Duis lacus turpis, pellentesque sit amet semper et,
          dapibus id mi. Curabitur lobortis in neque ac consectetur. Donec porttitor ligula vitae
          elementuende.
        </p>
      </div>
    </div>,
