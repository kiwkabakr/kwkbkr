...
const userBetSchema = new mongoose_1.Schema({
    ...
    betId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Bet', required: true, index: true },
...
exports.UserBet = mongoose_1.default.model('UserBet', userBetSchema);
//# sourceMappingURL=UserBet.js.map